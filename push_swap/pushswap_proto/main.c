...
/*   Updated: 2022/06/13 19:50:50 by jibang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
////////////////////////////////////////////////////////////////////////////
	...
	// ft_sort_two_b(&stack_a, &stack_b);
	// ft_sort_three_b(&stack_a, &stack_b);
	...
	else if (k == 2)
	{
		...
		sort_only_two(&stack_a);
	}
	else if (k == 1 || k == 0)
		sort_nothing();
	else
		logic_on_a(&stack_a, &stack_b, k, 0);
...
ft_printf("======after ops======\n");
	...
	//put nums from 0 to k - 1, total k, into stack A [x]
	//sort using pa, pb, sa, sb, ra, rb, rra, rrb, rrr, sss [ing]

	//match the index to parsed[] array, and print them
	return (0);
}
